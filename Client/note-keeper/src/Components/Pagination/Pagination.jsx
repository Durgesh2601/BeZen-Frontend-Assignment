...
export const Pages = ({ page, setPage }) => {
    ...
    return (<Row align='center' className='pagination-row'>
        {loading ? <Skeleton/> : totalLength && 
        <Pagination defaultCurrent={page} total={totalLength} pageSize={6} onChange={handleChange}/>}
    </Row>)
}